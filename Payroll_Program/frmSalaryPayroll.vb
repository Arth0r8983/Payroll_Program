Public Class frmSalaryPayroll
    ...
    Private Sub btnCalculate_Click(sender As Object, e As EventArgs) Handles btnCalculate.Click
        ...
        Call Get_And_Validate_Input(dblYearlySalary, dblCumulativeYearlyGrossPay, blnValidated)

        If blnValidated = True Then
            Call Calculate_Salary_Employee_Pay(dblYearlySalary, dblCumulativeYearlyGrossPay, dblGrossPay, dblFICA, dblStateTaxes, dblFederalTaxes, dblNetPay)
            Call Display_Totals(dblGrossPay, dblFICA, dblStateTaxes, dblFederalTaxes, dblNetPay)
        End If
    End Sub

    Private Sub Get_And_Validate_Input(ByRef dblYearlySalary As Double, ByRef dblCumulativeYearlyGrossPay As Double, ByRef blnValidated As Boolean)
        ...
        If blnValidated = True Then
            Call Get_And_Validate_Yearly_Salary(dblYearlySalary, blnValidated)
        End If
    ...
    Private Sub Get_And_Validate_Yearly_Salary(ByRef dblYearlySalary As Double, ByRef blnValidated As Boolean)
        If Double.TryParse(txtYearlySalary.Text, dblYearlySalary) Then
            dblYearlySalary = txtYearlySalary.Text
            If dblYearlySalary < 1 Then
    ...
    Private Sub Calculate_Salary_Employee_Pay(ByVal dblYearlySalary As Double, ByVal dblCumulativeYearlyGrossPay As Double, ByRef dblGrossPay As Double, ByRef dblFICA As Double, ByRef dblStateTaxes As Double, ByRef dblFederalTaxes As Double, ByRef dblNetPay As Double)
        dblGrossPay = Calculate_Gross_Pay(dblYearlySalary)
    ...
    Private Function Calculate_Gross_Pay(ByVal dblYearlySalary As Double)

        Return dblYearlySalary / 52
    End Function
